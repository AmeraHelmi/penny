...
******************************************************************************/
	 ...
	 function PennyTheme_render_login_page_uri(){
	?>
...
*****************************************************************************************/
	...
	function PennyTheme_display_social_login()
	{
		
		$images_url = get_bloginfo('template_url') . "/lib/social/img/";
		$PennyTheme_enable_facebook_login = get_option('PennyTheme_enable_facebook_login');
		$PennyTheme_enable_twitter_login 	= get_option('PennyTheme_enable_twitter_login');
		
		if($PennyTheme_enable_facebook_login == "yes" or $PennyTheme_enable_twitter_login == "yes"):
		?>
        
        	<p>
					<label><?php _e('Connect with:','PennyTheme'); ?></label>
        
        
        <?php
		
		 if( $PennyTheme_enable_facebook_login == "yes" ) : ?>
			...
			<?php endif; ?>
			<?php if( $PennyTheme_enable_twitter_login == "yes" ) : ?>
		...
		<input type="hidden" name="client_id" value="<?php echo get_option( 'PennyTheme_facebook_app_id' ); ?>" />
...
*****************************************************************************************/
	...
	function PennyTheme_social_connect_process_login( $is_ajax = false ){
	...
	$redirect_to = PennyTheme_my_account_link();
	$redirect_to = apply_filters('PennyTheme_filter_social_redirect_url', $redirect_to, $social_connect_provider);
...
*****************************************************************************************/
	...
	add_action( 'login_form_social_connect', 	'PennyTheme_social_connect_process_login');
	add_filter('login_form', 					'PennyTheme_display_social_login');
	add_action( 'wp_footer', 					'PennyTheme_render_login_page_uri' );
	add_filter('register_form', 					'PennyTheme_display_social_login');

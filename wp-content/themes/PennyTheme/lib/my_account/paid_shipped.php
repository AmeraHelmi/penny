...
function PennyTheme_display_my_account_paid_ship_itms_fncs()
{
...
<div id="content">
		<!-- page content here -->	
            	...
            	<div class="box_title"><?php _e("Paid and Shipped Items",'PennyTheme'); ?></div>
				...
				while ( have_posts() ) : the_post();
					PennyTheme_get_post_my_account_shpd();
				endwhile;

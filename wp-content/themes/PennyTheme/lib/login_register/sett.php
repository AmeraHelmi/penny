...
function PennyTheme_new_user_notification($user_id, $plaintext_pass = '') {
	$user = new WP_User($user_id);
    
	$subject 	= get_option('PennyTheme_new_user_email_subject');
	$message 	= get_option('PennyTheme_new_user_email_message');	
	...
	PennyTheme_send_email($user_email, $subject, $message);

}

function PennyTheme_new_user_notification_admin($user_id) {
	$user = new WP_User($user_id);
    
	$subject 	= get_option('PennyTheme_new_user_email_admin_subject');
	$message 	= get_option('PennyTheme_new_user_email_admin_message');	
